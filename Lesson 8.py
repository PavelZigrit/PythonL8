...
class Student:
    def __init__(self, name, surname, gender):
        ...
        self.grades = {}  # {Python: [10, 10, 10], Python3.8: [5, 5, 2]}
...
best_student.courses_in_progress += ['Python3.8']
best_student.add_courses('Python2.0')

bad_student = Student('Pavel', 'Shak', 'your_gender')
bad_student.courses_in_progress += ['Python']
bad_student.courses_in_progress += ['Python3.8']
bad_student.add_courses('Python2.1')

cool_reviewer = Reviewer("Someone", "RevBuddy")
cool_reviewer.courses_attached += ['Python']
cool_reviewer.courses_attached += ['Python3.8']
...
cool_reviewer.rate_hw(best_student, 'Python', 10)
cool_reviewer.rate_hw(best_student, 'Python', 10)
cool_reviewer.rate_hw(best_student, 'Python3.8', 7)
cool_reviewer.rate_hw(best_student, 'Python3.8', 9)
cool_reviewer.rate_hw(best_student, 'Python3.8', 8)

cool_reviewer.rate_hw(bad_student, 'Python3.8', 5)
cool_reviewer.rate_hw(bad_student, 'Python3.8', 5)
cool_reviewer.rate_hw(bad_student, 'Python3.8', 5)
...
def_lecturer = Lecturer('Def', 'Lect')
